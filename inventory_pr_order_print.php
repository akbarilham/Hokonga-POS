...
// 상세 발주 정보
$query_HC = "SELECT count(uid) FROM shop_cart WHERE order_num = '$pm_po_num' AND f_class = 'in' AND expire = '1'";
        ...
        <div class="panel">
            ...
            <table class="table table-bordered table-invoice">
				...
				$query_H = "SELECT uid,prd_uid,pcode,qty,product_color,product_size,p_option1,p_option2,p_option3,p_option4,p_option5,
							...
							WHERE order_num = '$pm_po_num' AND f_class = 'in' AND expire = '1' ORDER BY date ASC";
