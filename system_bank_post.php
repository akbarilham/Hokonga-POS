...
?>
        ...
        <div class="panel-body">
							...
							<div class="form">
                                <form class="cmxform form-horizontal adminex-form" name="signformnow" method="post" action="system_bank_post.php">
								...
								<input type='hidden' name='key' value='<?=$key?>'>
									...
									<div class="form-group ">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" id="cname" name="account_code" type="text" />
                                        </div>
                                    </div>
									...
									<div class="form-group ">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" id="cname" name="account_name" type="text" />
                                        </div>
                                    </div>
									...
									<div class="form-group ">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" id="cname" name="swift_code" type="text" />
                                        </div>
                                    </div>
									...
									<div class="form-group ">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" id="cname" name="bank_manager" type="text" />
                                        </div>
                                    </div>
...
<?
  ...
  $rm_query = "SELECT bank_code FROM code_bank ORDER BY bank_code DESC";
  ...
  if($max_room == "") {
    ...
    $new_shop_code = "BN_". "$new_room_num";
  }
  ...
  if($pin_key) {
    ...
    $query_M1 = "INSERT INTO code_bank (uid,branch_code,gate,bank_code,bank_name,branch_name,swift_code,
          account_name,account_code,currency,manager,email,homepage,userlevel,signdate) values ('',
          '$new_branch_code','$user_gate','$new_shop_code','$bank_name','$branch_name','$swift_code',
          '$account_name','$account_code','$bank_currency','$bank_manager','$email','$homepage','1',$signdate)";
