...
<?php
		...
		$result_ftmx = mysqli_query($dbconn, $query_ftmx);
		$row_ftmx = mysqli_num_rows($result_ftmx);

		while($row_ftmx = mysqli_fetch_object($result_ftmx)) {
			$R_uid = $row_ftmx->uid;
			...
			$dp_result = mysqli_query($dbconn, $dp_query);
