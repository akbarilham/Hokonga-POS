...
$next_dates = "$next_Y"."-"."$this_m"."-"."$this_d";
?>
        ...
        <div class="panel-body">
							...
							<div class="form">
                                <form class="cmxform form-horizontal adminex-form" name="signformnow" method="post" action="system_voucher_post.php">
								...
								<input type="hidden" name="user_id" value="<?=$login_id?>">
									...
									<div class="form-group ">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" id="cname" name="new_voucher_value" type="text" required />
                                        </div>
										<div class="col-sm-6">
									...
									<div class="form-group ">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" id="cname" name="new_qty_org" type="text" />
                                        </div>
                                    </div>
									...
									<div class="form-group ">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" id="cname" name="new_post_dates" value="<?=$this_dates?>" type="date" />
                                        </div>
                                    </div>
									...
									<div class="form-group ">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" id="cname" name="new_expire_dates" value="<?=$next_dates?>" type="date" />
                                        </div>
                                    </div>
...
<?
  ...
  $new_voucher_code = "VC-"."$exp_branch_code"."-"."$signdate";
  
  
  
  if($pin_key) {

    $query_M1 = "INSERT INTO shop_voucher (uid,branch_code,voucher_code,voucher_value,
          currency,qty_org,qty_now,post_date,expire_date)
          values ('','$new_branch_code','$new_voucher_code','$new_voucher_value',
          '$new_currency','$new_qty_org','$new_qty_org','$new_post_dates','$new_expire_dates')";
    $result_M1 = mysql_query($query_M1);
    if (!$result_M1) { error("QUERY_ERROR"); exit; }

  echo("<meta http-equiv='Refresh' content='0; URL=$home/system_voucher.php'>");
  exit;
