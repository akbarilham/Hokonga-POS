...
include "config/user_functions_{$lang}.inc";
	...
	$b_code = substr($m_catg,0,2); // Det Main Category Code
	
	// Mid-category Code
	$rm_query = "SELECT scode FROM wms_catgsml WHERE mcode = '$m_catg' ORDER BY scode DESC";
  ...
  if($max_scode == "") {
	...
	$query_S1  = "INSERT INTO wms_catgsml (lcode, mcode, scode, sname, branch_code) 
	              VALUES ('$b_code','$m_catg','$addcode','$s_name', '$login_branch')";
