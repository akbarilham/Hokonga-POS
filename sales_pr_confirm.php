...
$link_list = "$home/sales_pr_confirm.php?sorting_key=$sorting_key";
$link_upd = "$home/sales_pr_confirm.php?sorting_key=$sorting_key&keyfield=$keyfield&key=$key&page=$page";

$link_act = "$home/sales_pr_confirm_act.php?sorting_key=$sorting_key&keyfield=$keyfield&key=$key&page=$page";
?>
...
?>
        ...
        <div class="panel-body">
			...
			<?
			echo ("
			<form name='search' method='post' action='sales_pr_confirm.php'>
			<div class='col-sm-2'>
            ...
            <ul role='menu' class='dropdown-menu' style='margin-left: -80px'>");
				// if($pay_status < 2) {
					if($order_status > 1) {
						...
						echo ("<li><a href='$link_act&act_mode=del&uid=$li_uid&po_num=$po_num'><i class='fa fa-times-circle'></i> $txt_comm_frm08</a></li>");
						echo ("<li><a href='$link_act&act_mode=approve&uid=$li_uid'><i class='fa fa-gavel'></i> $txt_invn_stockin_47</a></li>");
					}
					if($do_status > 0) {
						echo ("<li><a href='#'><font color=#AAAAAA><i class='fa fa-envelope'></i> Send PR</a></font></li>");
					} else {
						echo ("<li><a href='$link_act&act_mode=send&uid=$li_uid'><i class='fa fa-envelope'></i> Send PR</a></li>");
					}
