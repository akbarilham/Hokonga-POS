...
?>
        ...
        <div class="panel-body">
							...
							<div class="form">
                                <form class="cmxform form-horizontal adminex-form" name="signformnow" method="post" action="system_insurance_del.php">
								...
								<input type='hidden' name='key' value='<?=$key?>'>
									...
									<div class="form-group ">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" id="cname" name="agent_name" value="<?=$agent_name?>" type="text" />
                                        </div>
                                    </div>
...
<?
  ...
  $query  = "DELETE FROM code_insurance WHERE uid = '$user_uid'"; 
  $result = mysql_query($query);
  if(!$result) { error("QUERY_ERROR"); exit; }
