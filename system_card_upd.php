...
?>
        ...
        <header class="panel-heading">
            ...
            <span class="tools pull-right">
				<a href="system_card_del.php?uid=<?=$user_uid?>" class="fa fa-trash-o"></a>
        ...
        <div class="panel-body">
							...
							<div class="form">
                                <form class="cmxform form-horizontal adminex-form" name="signformnow" method="post" action="system_card_upd.php">
								...
								<input type='hidden' name='user_uid' value='<?=$user_uid?>'>
									...
									<div class="form-group ">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" id="cname" name="card_manager" value="<?=$card_manager?>" type="text" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control " id="cemail" type="email" name="email" value="<?=$email?>" />
                                        </div>
                                    </div>
									...
									<div class="form-group ">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" id="cname" name="homepage" value="<?=$homepage?>" type="url" />
                                        </div>
                                    </div>
...
<?
  ...
  $query  = "UPDATE code_card SET branch_code = '$new_branch_code', userlevel = '$userlevel', card_name = '$card_name', 
              card_rate = '$card_rate', currency = '$upd_bank_currency', bank_name = '$bank_name', manager = '$card_manager', 
			  email = '$email', homepage = '$homepage', zipcode = '$zipcode', 
              addr1 = '$addr1', addr2 = '$addr2', phone1 = '$phone1', phone2 = '$phone2', phone_fax = '$phone_fax', 
              phone_cell = '$phone_cell', memo = '$memo' WHERE uid = '$user_uid'"; 
