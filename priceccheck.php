      ...
      <div class="row">
        ...
        <?}else{?>
          ...
          <div class="col-lg-4" id='side'>
                  ...
                  <span class="tools pull-right">
					...
					<?php
						if($module_0509 == '1'){
							...
							echo '<a href="'.$home.'/pos_recode.php"  class="fa fa-book" data-toggle="tooltip" title="MASTER ITEM">RECODE</a>';
						}
					?>
		    ...
		    <?php  echo '<a href="'.$home.'/pos_logout.php" class="fa fa-sign-out" data-toggle="tooltip" title="LOGOUT"> LOGOUT</a>'; ?>
                   </span>
                </div>
