...
?>
        ...
        <header class="panel-heading">
            <?=$title_module_08043?> &gt; <?=$txt_web_mailing_07?>
		...
		<div class="panel-body">
							...
							<div class="form">
                                <form class="cmxform form-horizontal adminex-form" name="signformnow" method="post" action="crm_mailingB_post.php">
...
<?
  ...
  if($pin_key) {
		...
		if ($rows) {
			...
			$query_add = "INSERT INTO mail_user_list (uid,room,name,email,phone,post_date,last_date,lang,mail_now,branch_code)
						VALUES ('','host','$name','$email','$phone','$dates','$dates','$lang','1','$new_branch_code')";
  ...
  echo("<meta http-equiv='Refresh' content='0; URL=$home/crm_mailingB.php'>");
  exit;
