...
?>
        ...
        <header class="panel-heading">
            ...
            <span class="tools pull-right">
				<a href="inventory_unit_del.php?uid=<?=$user_uid?>" class="fa fa-trash-o"></a>
        ...
        <div class="panel-body">
							...
							<div class="form">
                                <form class="cmxform form-horizontal adminex-form" name="signformnow" method="post" action="inventory_unit_upd.php">
								<input type="hidden" name="step_next" value="permit_okay">
								<input type="hidden" name="user_id" value="<?=$login_id?>">
								<input type='hidden' name='user_uid' value='<?=$user_uid?>'>
								<input type='hidden' name='old_unit_name' value='<?=$unit_name?>'>
...
<?
	...
	$unit_desc = addslashes($unit_desc);

	$query_upd = "UPDATE shop_product_unit SET unit_name = '$unit_name', unit_desc = '$unit_desc' WHERE uid = '$user_uid'";  
	$result_upd = mysql_query($query_upd);
    if(!$result_upd) { error("QUERY_ERROR"); exit; }
	
	$query_upd2 = "UPDATE shop_product_catg_unit SET unit_name = '$unit_name' WHERE unit_name = '$old_unit_name'";  
