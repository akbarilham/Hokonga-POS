...
?>
        ...
        <header class="panel-heading">
            ...
            <span class="tools pull-right">
				<a href="system_tcourse_del.php?uid=<?=$t_uid?>" class="fa fa-trash-o"></a>
        ...
        <div class="panel-body">
							...
							<div class="form">
                                <form class="cmxform form-horizontal adminex-form" name="signformnow" method="post" action="system_tcourse_upd.php">
								...
								<input type='hidden' name='catg' value='<?=$catg?>'>
									...
									<div class="form-group ">
                                        <label for="cname" class="control-label col-sm-3"><?=$txt_sys_tcourse_14?></label>
                                        <div class="col-sm-9">
                                            <textarea class="form-control" id="cname" name="course_detail"><?=$course_detail?></textarea>
                                        </div>
                                    </div>
									
									<div class="form-group ">
                                        <label for="cname" class="control-label col-sm-3"><?=$txt_sys_tcourse_15?></label>
                                        <div class="col-sm-9">
    <? echo ("
	<table width=600 cellspacing=0 cellpadding=0 border=0>
    <tr>
      <td width=200 height=20>
        <input type=checkbox name='eta01_chk' value='1' $eta01_chk_chk> 
        <input readonly type=text name='eta01_name' value='$eta01_name' maxlength=20 style='WIDTH: 140px'>
      </td>
      <td width=200 height=20>
        <input type=checkbox name='eta02_chk' value='1' $eta02_chk_chk> 
        <input readonly type=text name='eta02_name' value='$eta02_name' maxlength=20 style='WIDTH: 140px'>
      </td>
      <td width=200 height=20>
        <input type=checkbox name='eta03_chk' value='1' $eta03_chk_chk> 
        <input readonly type=text name='eta03_name' value='$eta03_name' maxlength=20 style='WIDTH: 140px'>
      </td>
    </tr>
    <tr><td colspan=3 height=2></td></tr>
    <tr>
      <td height=20>
        <input type=checkbox name='eta04_chk' value='1' $eta04_chk_chk> 
        <input readonly type=text name='eta04_name' value='$eta04_name' maxlength=20 style='WIDTH: 140px'>
      </td>
      <td height=20>
        <input type=checkbox name='eta05_chk' value='1' $eta05_chk_chk> 
        <input readonly type=text name='eta05_name' value='$eta05_name' maxlength=20 style='WIDTH: 140px'>
      </td>
      <td height=20>
        <input type=checkbox name='eta06_chk' value='1' $eta06_chk_chk> 
        <input readonly type=text name='eta06_name' value='$eta06_name' maxlength=20 style='WIDTH: 140px'>
      </td>
    </tr>
    <tr><td colspan=3 height=2></td></tr>
    <tr>
      <td height=20>
        <input type=checkbox name='eta07_chk' value='1' $eta07_chk_chk> 
        <input type=text name='eta07_name' value='$eta07_name' maxlength=20 style='WIDTH: 140px'>
      </td>
      <td height=20>
        <input type=checkbox name='eta08_chk' value='1' $eta08_chk_chk> 
        <input type=text name='eta08_name' value='$eta08_name' maxlength=20 style='WIDTH: 140px'>
      </td>
      <td height=20>
        <input type=checkbox name='eta09_chk' value='1' $eta09_chk_chk> 
        <input type=text name='eta09_name' value='$eta09_name' maxlength=20 style='WIDTH: 140px'>
      </td>
    </tr>
    </table>");
	?>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-4">
                                            <input readonly class="form-control" id="signdate" name="signdate" value="<?=$post_date_txt?>" type="text" />
                                        </div>
...
<?
  ...
  if(!$eta01_chk) { $eta01_chk = "0"; }
  if(!$eta02_chk) { $eta02_chk = "0"; }
  if(!$eta03_chk) { $eta03_chk = "0"; }
  if(!$eta04_chk) { $eta04_chk = "0"; }
  if(!$eta05_chk) { $eta05_chk = "0"; }
  if(!$eta06_chk) { $eta06_chk = "0"; }
  if(!$eta07_chk) { $eta07_chk = "0"; }
  if(!$eta08_chk) { $eta08_chk = "0"; }
  if(!$eta09_chk) { $eta09_chk = "0"; }
  if(!$eta10_chk) { $eta10_chk = "0"; }

  
  $course_detail = addslashes($course_detail);
  ...
  $query  = "UPDATE dirlist_train SET lecturer = '$lecturer', trainee_type = '$trainee_type', 
              duration = '$duration', tuition = '$tuition', course_open = '$course_open', course_close = '$course_close', 
              class_hours = '$class_hours', course_detail = '$course_detail', memo = '$memo', 
              eta01_chk = '$eta01_chk', eta02_chk = '$eta02_chk', eta03_chk = '$eta03_chk', eta04_chk = '$eta04_chk', 
              eta05_chk = '$eta05_chk', eta06_chk = '$eta06_chk', eta07_chk = '$eta07_chk', eta08_chk = '$eta08_chk', 
              eta09_chk = '$eta09_chk', eta07_name = '$eta07_name', eta08_name = '$eta08_name', eta09_name = '$eta09_name', 
              eta10_name = '$eta10_name' WHERE uid = '$t_uid'"; 
