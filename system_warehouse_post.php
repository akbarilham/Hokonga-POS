...
?>
        ...
        <div class="panel-body">
							...
							<div class="form">
                                <form class="cmxform form-horizontal adminex-form" name="signformnow" method="post" action="system_warehouse_post.php">
...
<?
  ...
  $rm_query = "SELECT gudang_code FROM code_gudang ORDER BY gudang_code DESC";
  ...
  if($max_room == "") {
    ...
    $new_shop_code = "WH_". "$new_room_num";
  }
  ...
  if($pin_key) {
    ...
    $query_M1 = "INSERT INTO code_gudang (uid,branch_code,gate,gudang_code,gudang_name,manager,
          email,homepage,userlevel,signdate) values ('','$new_branch_code','$login_gate','$new_shop_code',
          '$shop_name','$shop_manager','$email','$homepage','1',$signdate)";
