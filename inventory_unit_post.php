...
?>
        ...
        <div class="panel-body">
							...
							<div class="form">
                                <form class="cmxform form-horizontal adminex-form" name="signformnow" method="post" action="inventory_unit_post.php">
								...
								<input type="hidden" name="user_id" value="<?=$login_id?>">
									...
									<div class="form-group ">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" id="unit_name" name="unit_name" type="text" required />
                                        </div>
                                    </div>
									...
									<div class="form-group ">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" id="unit_desc" name="unit_desc" type="text" />
                                        </div>
                                    </div>
...
<?
  ...
  if($pin_key) {
	...
	$query_w  = "INSERT INTO shop_product_unit (uid, branch_code, unit_name, unit_desc) VALUES ('', '$login_branch', '$unit_name', '$unit_desc')";
