          ...
          <section class="panel">
			...
			<form name="form" id="form" action='wms_post_so.php' method='post' onsubmit="return validateForm()" enctype="multipart/form-data">
              <table class="table table-hover personal-task">
                <tr>
                    <td>NO PO</td>
                    <td colspan="5"><input readonly type='text' class='form-control' name='po_no' value='<?=$po_num?>'>
                    </td>                
                </tr>
                <tr>
                    <td>NAMA PT</td>
            ...
            <?
              $query_branchcount  = "SELECT count(uid) FROM client_branch ";
              ...
              $query_branch     = "SELECT uid,branch_code,branch_name,addr1 FROM client_branch ";
              ...
              $addr =mysql_result($fetch_branch,$k,3);
            ...
            ?>
                    ...
                    <td>KOTA</td>
                    <td><input type='text' class='form-control' name='so_no' value='<?=$so_num?>'></td>
                </tr>
                <tr>
                    <td>CLASS</td>
                    <td><input type='text' class='form-control' name='class' value='<?=$so_num?>'></td>
                    <td>GM</td>
                    <td><input type='text' class='form-control' name='gm' value='<?=$so_num?>'></td>                    
                    <td>STATUS</td>
                    <td><input readonly type='text' class='form-control' name='stat' value="<?=$stat?>"></td>
                </tr>
                <tr>
                    <td>NAMA SA</td>
                    <td><input type='text' class='form-control' name='nama_sa' value="<?=$login_id?>"></td>
                    <td>NOMOR HP</td>
                    <td><input type='text' class='form-control' name='no_hp' value="<?=$no_hp?>"></td>
                </tr>
                <tr>
                    <td>ORDER DATE</td>
                    <td><input type='date' class='form-control' name='date' data-date="" data-date-format="DD MMMM YYYY"></td>
                    <td>DELIVERY DATE</td>
                    <td><input type='date' class='form-control' id='datepicker' name='so_date' data-date="" data-date-format="DD MMMM YYYY">
                    </td>                    
                </tr>                
				        <tr>
					          <td>JAM</td>
                    <td><input type="text" id="clockpicker" class="input-group clockpicker form-control" value="<?=$so_date?>">
                    </td>
				        </tr>
              </table>
