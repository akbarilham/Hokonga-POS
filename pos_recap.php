        ...
        <section class="wikkel">
          <img src="img/feelbuy-logo.jpg" style="margin-bottom: 2%; width: 13%; height: 7%">
            ...
            <div class="row state-overview">
             ...
             <a href="<?php echo $home?>/pos_admin.php" class="btn btn-primary" style=" color:#fff; width:10%;border-color:#81C784;border-bottom-left-radius:0px;border-top-left-radius:0px;margin-bottom:10px">BACK</a>
              ...
              <div class="col-lg-10" style="margin-left: 1%">
                  ...
                  for ($k=0; $k < $reken_uidk; $k++) { 
                    ...
                    if (!$fetch_tyd) { error("QUERY_ERROR"); exit; }
                      ...
                      $tyd_qty = @mysqli_result($fetch_tyd,$k,2);
                      $tyd_tunai = @mysqli_result($fetch_tyd,$k,3);
                      $tyd_ppn = @mysqli_result($fetch_tyd,$k,4);
                      $tyd_debit = @mysqli_result($fetch_tyd,$k,5);
                      $tyd_credit = @mysqli_result($fetch_tyd,$k,6);
                      $tyd_kembali = @mysqli_result($fetch_tyd,$k,7);
                      $tyd_bruto = @mysqli_result($fetch_tyd,$k,8);
                      $tyd_netto = @mysqli_result($fetch_tyd,$k,9);
                  ?>
                  <tr>
                <?php
                if ($tyd_kassier == '') {
                ...
                <td style="text-align:right;"><?php echo number_format($tyd_tunai)?></td>
                <td style="text-align:right;"><?php echo number_format($tyd_ppn)?></td>
                <td style="text-align:right;"><?php echo number_format($tyd_debit)?></td>
                <td style="text-align:right;"><?php echo number_format($tyd_credit)?></td>
                <td style="text-align:right;"><?php echo number_format($tyd_kembali)?></td>
                ...
                <?php
                  ...
                  <tr>
                    ...
                    <td style="text-align:right;"><b><?php echo number_format($tyd_tunai_K3)?></b></td>
                    <td style="text-align:right;"><b><?php echo number_format($tyd_ppn_K3)?></b></td>
                    <td style="text-align:right;"><b><?php echo number_format($tyd_debit_K3)?></b></td>
                    <td style="text-align:right;"><b><?php echo number_format($tyd_credit_K3)?></b></td>
                    <td style="text-align:right;"><b><?php echo number_format($tyd_kembali_K3)?></b></td>
              ...
              <div class="col-lg-10" style="margin-left: 1%">
                  ...
                  for ($k=0; $k < $reken_uidk; $k++) { 
                    ...
                    if (!$fetch_totale) { error("QUERY_ERROR"); exit; }
                      $totale_kassier = @mysqli_result($fetch_totale,$k,0);
                      $totale_transaksie_J = @mysqli_result($fetch_totale,$k,1);
                      $totale_qty = @mysqli_result($fetch_totale,$k,2);
                      $totale_tunai = @mysqli_result($fetch_totale,$k,3);
                      $totale_ppn = @mysqli_result($fetch_totale,$k,4);
                      $totale_debit = @mysqli_result($fetch_totale,$k,5);
                      $totale_credit = @mysqli_result($fetch_totale,$k,6);
                      $totale_kembali = @mysqli_result($fetch_totale,$k,7);
                      $totale_bruto = @mysqli_result($fetch_totale,$k,8);
                      $totale_netto = @mysqli_result($fetch_totale,$k,9);  
                  ?>
                  <tr>
                <?php
                if ($totale_kassier == '') {
                ...
                <td style="text-align:right;"><?php echo number_format($totale_tunai)?></td>
                <td style="text-align:right;"><?php echo number_format($totale_ppn)?></td>
                <td style="text-align:right;"><?php echo number_format($totale_debit)?></td>
                <td style="text-align:right;"><?php echo number_format($totale_credit)?></td>
                <td style="text-align:right;"><?php echo number_format($totale_kembali)?></td>
                ...
                ?>                
                  <tr>
                    ...
                    <td style="text-align:right;"><b><?php echo number_format($totale_tunai_K3)?></b></td>
                    <td style="text-align:right;"><b><?php echo number_format($totale_ppn_K3)?></b></td>
                    <td style="text-align:right;"><b><?php echo number_format($totale_debit_K3)?></b></td>
                    <td style="text-align:right;"><b><?php echo number_format($totale_credit_K3)?></b></td>
                    <td style="text-align:right;"><b><?php echo number_format($totale_kembali_K3)?></b></td>
