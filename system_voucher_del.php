...
?>
        ...
        <div class="panel-body">
							...
							<div class="form">
                                <form class="cmxform form-horizontal adminex-form" name="signformnow" method="post" action="system_voucher_del.php">
...
<?
	...
	$query = "DELETE FROM shop_voucher WHERE uid = '$shop_uid'"; 
	$result = mysql_query($query);
