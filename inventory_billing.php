...
$link_list = "$home/inventory_billing.php?sorting_key=$sorting_key";
$link_upd = "$home/inventory_billing.php?sorting_key=$sorting_key&keyfield=$keyfield&key=$key&page=$page";

$link_list1 = "$home/inventory_billing.php?sorting_key=$sorting_key";
?>
...
?>
        ...
        <div class="panel-body">
			...
			<?
			echo ("
			<form name='search' method='post' action='inventory_billing.php'>
			<div class='col-sm-2'>
...
?>
		...
		<form name='signform' class="cmxform form-horizontal adminex-form" method='post' action="inventory_billing.php">
...
<?
  ...
  if($add_mode == "LIST_CHG") {
    ...
    // 리스트로 되돌아 가기
    echo("<meta http-equiv='Refresh' content='0; URL=$home/inventory_billing.php?sorting_key=$sorting_key&keyfield=$keyfield&key=$key&page=$page'>");
    exit;
    ...
    // 리스트로 되돌아 가기
    echo("<meta http-equiv='Refresh' content='0; URL=$home/inventory_billing.php'>");
    exit;
