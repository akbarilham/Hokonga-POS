...
<section id="container" class="">
	...
	<section id="main-content">
        ...
        <header class="panel-heading">
            <?=$hsm_name_09_42?> - <?=$txt_sys_category_02?>
		...
		<?
		echo ("
		<form name='signform1' method='post' action='system_payclass_post.php'>
...
<?
  	...
  	if($b_code == "add") {
	    ...
	    $query_L1  = "INSERT INTO code_payclass1 (lcode, lname) VALUES ('$add_code','$b_name')";
...
<section id="container" class="">
	...
	<section id="main-content">
		...
		<form name='signform2' method='post' action='system_payclass_post.php'>
		<input type='hidden' name='step_next' value='permit_okay'>
		<input type='hidden' name='gate' value='$login_gate'>
		...
		$mid_query = "SELECT * FROM code_payclass2 WHERE lcode = '$b_code' ORDER BY mcode";
...
<?
	...
	$b_code = substr($addcode, 0,1); // 대분류 코드를 얻는다.
	$m_name = addslashes($m_name);

	$query_M1  = "INSERT INTO code_payclass2 (lcode, mcode, mname) VALUES ('$b_code','$addcode','$m_name')";
