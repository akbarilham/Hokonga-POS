...
$link_dir = "$home";
$link_list = "$home/crm_mailingA.php";
$link_post = "$home/crm_mailingA_post.php";
$link_upd = "$home/crm_mailingA_upd.php";
$link_del = "$home/crm_mailingA_del.php";
...
for($i = $first; $i <= $last; $i++) {
   ...
   if(!strcmp($key,"$name") && $key) {
    ...
    if($crmflag == "1") {
		echo("<td bgcolor=#FFFFFF align=\"center\"><a href=\"$link_dir/work_mailing_M_remove.php?lang=$lang&gate=$login_gate&uid=$uid2&page=$page&keyfield=$keyfield&key=$key\" onMouseOver=\"status='drop this record'\" onMouseOut=\"status=''\"><font color=#888888>$txt_web_mailing_021</font></a></td>");
	} else {
		echo("<td bgcolor=#FFFFFF align=\"center\"><a href=\"$link_dir/work_mailing_M_add.php?lang=$lang&gate=$login_gate&uid=$uid2&page=$page&keyfield=$keyfield&key=$key\" onMouseOver=\"status='Add this To the Mailing List'\" onMouseOut=\"status=''\"><font color=green>$txt_web_mailing_022</font></a></td>");
	}
	echo("</tr>");
