...
$account_bank_currency = $row->currency;
...
?>
        ...
        <div class="panel-body">
							...
							<div class="form">
                                <form class="cmxform form-horizontal adminex-form" name="signformnow" method="post" action="system_bank_upd.php">
								...
								<input type='hidden' name='key' value='<?=$key?>'>
									...
									<div class="form-group ">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" id="cname" name="bank_manager" value="<?=$bank_manager?>" type="text" />
                                        </div>
                                    </div>
...
<?
  ...
  $query  = "UPDATE code_bank SET gate = '$user_gate', userlevel = '$userlevel', bank_name = '$bank_name', 
              branch_name = '$branch_name', account_code = '$account_code', account_name = '$account_name', 
              swift_code = '$swift_code', currency = '$upd_bank_currency', initial = '$initial', 
              manager = '$bank_manager', email = '$email', homepage = '$homepage', zipcode = '$zipcode', 
