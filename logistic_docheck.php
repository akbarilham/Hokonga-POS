...
$link_list = "$home/logistic_docheck.php?sorting_key=$sorting_key";
$link_upd = "$home/logistic_docheck.php?sorting_key=$sorting_key&keyfield=$keyfield&key=$key&page=$page";

$link_act = "$home/logistic_docheck_act.php?sorting_key=$sorting_key&keyfield=$keyfield&key=$key&page=$page";
?>
...
?>
        ...
        <div class="panel-body">
			...
			<?
			echo ("
			<form name='search' method='post' action='logistic_docheck.php'>
			<div class='col-sm-2'>
...
for($i = $first; $i <= $last; $i++) {
		...
		<div class='btn-group'>
            ...
            <ul role='menu' class='dropdown-menu' style='margin-left: -80px'>");
					...
					if($date_do_check > 1) {
						...
						echo ("<li><a href='$link_act&act_mode=stage2&uid=$do_uid'><i class='fa fa-check'></i> $txt_invn_stockin_63</a></li>");
					}
  ...
  if($mode == "check" AND $do_uid == $uid) {
	...
	if($qs_sx_num != "") {
		...
		echo ("
		<form name='signform' method='post' action='logistic_docheck.php'>
...
<?
  ...
  $m_ip = getenv('REMOTE_ADDR');
    ...
    echo("<meta http-equiv='Refresh' content='0; URL=$home/logistic_docheck.php?sorting_key=$sorting_key&keyfield=$keyfield&key=$key&page=$page&mode=check&do_num=$do_num&uid=$uid'>");
    exit;
