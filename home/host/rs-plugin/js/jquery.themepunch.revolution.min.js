...
(function (e, t) {
    ...
    e.fn.extend({revolution: function (t) {
    ...
    var d = function (n) {
        ...
        if (!a.hasClass("preview4")) {
            TweenLite.to(c, .5, {autoAlpha: 0, onComplete: function () {
                c.css({backgroundImage: "url(" + u + ")"});
                h.css({backgroundImage: "url(" + o + ")"})
            }});
            TweenLite.to(h, .5, {autoAlpha: 0, onComplete: function () {
            ...
            TweenLite.fromTo(p, .8, {force3D: true, x: 0}, {x: -c.width(), ease: Power3.easeOut, delay: 1, onComplete: function () {
                c.css({backgroundImage: "url(" + u + ")"});
                TweenLite.set(p, {x: 0})
            }});
            TweenLite.fromTo(d, .8, {force3D: true, x: 0}, {x: c.width(), ease: Power3.easeOut, delay: 1, onComplete: function () {
                h.css({backgroundImage: "url(" + o + ")"});
                TweenLite.set(d, {x: 0})
            }});
            TweenLite.fromTo(c, .8, {x: 0}, {force3D: true, x: -c.width(), ease: Power3.easeOut, delay: 1, onComplete: function () {
                TweenLite.set(c, {x: 0})
            }});
            TweenLite.fromTo(h, .8, {x: 0}, {force3D: true, x: c.width(), ease: Power3.easeOut, delay: 1, onComplete: function () {
                TweenLite.set(h, {x: 0})
            }})
        }
    ...
    var k = function (n, r, i, s, u, a) {
        ...
        if (f == 0) {
            ...
            a.find(".slotslide").each(function (t) {
                ...
                C = C + 1;
                if (C == N)C = 0;
                TweenLite.fromTo(o, T / 600, {opacity: 0, top: 0 - r.sloth, left: 0 - r.slotw, rotation: r.rotate}, {opacity: 1, transformPerspective: 600, top: 0, left: 0, scale: 1, rotation: 0, delay: (t * 15 + C * 30) / 1500, ease: Power2.easeOut, onComplete: function () {
        ...
        if (f == 2) {
            ...
            u.find(".slotslide").each(function () {
                var t = e(this);
                TweenLite.to(t, T / 1e3, {left: r.slotw, rotation: 0 - r.rotate, onComplete: function () {
                    L(n, r, a, u, i, s)
                }})
            });
            a.find(".slotslide").each(function () {
                var t = e(this);
                TweenLite.fromTo(t, T / 1e3, {left: 0 - r.slotw, rotation: r.rotate, transformPerspective: 600}, {left: 0, rotation: 0, ease: Power2.easeOut, onComplete: function () {
                    L(n, r, a, u, i, s)
                }})
            })
        }
        if (f == 3) {
            ...
            u.find(".slotslide").each(function () {
                var t = e(this);
                TweenLite.to(t, T / 1e3, {top: r.sloth, rotation: r.rotate, transformPerspective: 600, onComplete: function () {
                    L(n, r, a, u, i, s)
                }})
            });
            a.find(".slotslide").each(function () {
                var t = e(this);
                TweenLite.fromTo(t, T / 1e3, {top: 0 - r.sloth, rotation: r.rotate, transformPerspective: 600}, {top: 0, rotation: 0, ease: Power2.easeOut, onComplete: function () {
                    L(n, r, a, u, i, s)
                }})
            })
        }
        if (f == 4 || f == 5) {
            ...
            a.find(".slotslide").each(function (t) {
                ...
                TweenLite.fromTo(o, A * 3, {top: 0 - r.height, opacity: .5, rotation: r.rotate, transformPerspective: 600}, {top: 0, opacity: 1, rotation: 0, ease: Power2.easeInOut, delay: l, onComplete: function () {
                    if (t == r.slots - 1) {
                        L(n, r, a, u, i, s)
                    }
                }})
        ...
        if (f == 6) {
            ...
            u.find(".slotslide").each(function (t) {
                ...
                TweenLite.to(n, (T + i) / 1e3, {top: 0 + r.height, opacity: 1, rotation: r.rotate, transformPerspective: 600, ease: Power2.easeInOut})
            });
            a.find(".slotslide").each(function (t) {
                var o = e(this);
                if (t < r.slots / 2)var f = (t + 2) * 60; else var f = (2 + r.slots - t) * 60;
                TweenLite.fromTo(o, (T + f) / 1e3, {top: 0 - r.height, opacity: 1, rotation: r.rotate, transformPerspective: 600}, {top: 0, opacity: 1, rotation: 0, ease: Power2.easeInOut, onComplete: function () {
        ...
        if (f == 7) {
            ...
            u.find(".slotslide").each(function () {
                ...
                TweenLite.to(t, T / 1e3, {left: 0 - r.slotw / 2 + "px", top: 0 - r.height / 2 + "px", width: r.slotw * 2 + "px", height: r.height * 2 + "px", opacity: 0, rotation: r.rotate, transformPerspective: 600, ease: Power2.easeOut})
            });
            a.find(".slotslide").each(function (t) {
                var o = e(this).find("div");
                TweenLite.fromTo(o, T / 1e3, {left: 0, top: 0, opacity: 0, transformPerspective: 600}, {left: 0 - t * r.slotw + "px", ease: Power2.easeOut, top: 0 + "px", width: r.width, height: r.height, opacity: 1, rotation: 0, delay: .1, onComplete: function () {
                    L(n, r, a, u, i, s)
                }})
            })
        }
        if (f == 8) {
            ...
            u.find(".slotslide").each(function () {
                var t = e(this).find("div");
                TweenLite.to(t, T / 1e3, {left: 0 - r.width / 2 + "px", top: 0 - r.sloth / 2 + "px", width: r.width * 2 + "px", height: r.sloth * 2 + "px", transformPerspective: 600, opacity: 0, rotation: r.rotate})
            });
            a.find(".slotslide").each(function (t) {
                var o = e(this).find("div");
                TweenLite.fromTo(o, T / 1e3, {left: 0, top: 0, opacity: 0, transformPerspective: 600}, {left: 0 + "px", top: 0 - t * r.sloth + "px", width: a.find(".defaultimg").data("neww") + "px", height: a.find(".defaultimg").data("newh") + "px", opacity: 1, rotation: 0, onComplete: function () {
                    L(n, r, a, u, i, s)
                }})
            })
        }
        if (f == 9 || f == 10) {
            ...
            a.find(".slotslide").each(function (t) {
                var n = e(this);
                M++;
                TweenLite.fromTo(n, T / 1e3, {opacity: 0, transformPerspective: 600, left: 0, top: 0}, {opacity: 1, ease: Power2.easeInOut, delay: t * 4 / 1e3})
            });
            setTimeout(function () {
                L(n, r, a, u, i, s)
            }, T + M * 4)
        ...
        if (f == 12 || f == 13 || f == 14 || f == 15) {
            ...
            if (p == 6)q = .6;
            TweenLite.fromTo(P, z, {left: H, top: j, scale: q, opacity: F, rotation: r.rotate}, {opacity: 1, rotation: 0, left: 0, top: 0, scale: 1, ease: U, onComplete: function () {
                L(n, r, a, u, i, s);
            ...
            if (p != 1) {
                if (f == 12)TweenLite.to(X, W, {left: 0 - _ + "px", scale: I, opacity: F, rotation: r.rotate, ease: R}); else if (f == 15)TweenLite.to(X, W, {left: _ + "px", scale: I, opacity: F, rotation: r.rotate, ease: R}); else if (f == 13)TweenLite.to(X, W, {top: 0 - D + "px", scale: I, opacity: F, rotation: r.rotate, ease: R}); else if (f == 14)TweenLite.to(X, W, {top: D + "px", scale: I, opacity: F, rotation: r.rotate, ease: R})
            }
            i.css({opacity: 1})
        }
        if (f == 16) {
            ...
            TweenLite.set(s.find(".tp-half-two"), {width: _, height: D, overflow: "hidden", zIndex: 15, position: "absolute", top: D / 2, left: "0px", transformPerspective: 600, transformOrigin: "center bottom"});
            TweenLite.set(s.find(".tp-half-one"), {width: _, height: D / 2, overflow: "visible", zIndex: 10, position: "absolute", top: "0px", left: "0px", transformPerspective: 600, transformOrigin: "center top"});
            ...
            TweenLite.fromTo(s.find(".tp-half-one"), T / 1e3, {width: _, height: D / 2, position: "absolute", top: "0px", left: "0px", transformPerspective: 600, transformOrigin: "center top"}, {scale: Z, rotation: $, y: 0 - D - D / 4, ease: Power2.easeInOut});
            setTimeout(function () {
                TweenLite.set(s.find(".tp-half-one"), {overflow: "hidden"})
            }, 50);
            TweenLite.fromTo(s.find(".tp-half-one"), T / 2e3, {opacity: 1, transformPerspective: 600, transformOrigin: "center center"}, {opacity: 0, delay: T / 2e3});
            TweenLite.fromTo(s.find(".tp-half-two"), T / 1e3, {width: _, height: D, overflow: "hidden", position: "absolute", top: D / 2, left: "0px", transformPerspective: 600, transformOrigin: "center bottom"}, {scale: tt, rotation: J, y: D + D / 4, ease: Power2.easeInOut});
            TweenLite.fromTo(s.find(".tp-half-two"), T / 2e3, {opacity: 1, transformPerspective: 600, transformOrigin: "center center"}, {opacity: 0, delay: T / 2e3});
            if (s.html() != null)TweenLite.fromTo(i, (T - 200) / 1e3, {opacity: 0, scale: .8, x: r.width * G, y: D * Y, rotation: Q, transformPerspective: 600, transformOrigin: "center center"}, {rotation: 0, scale: 1, x: 0, y: 0, opacity: 1, ease: Power2.easeInOut});
            a.find(".defaultimg").css({opacity: 1});
            setTimeout(function () {
                s.css({position: "absolute", "z-index": 18});
                i.css({position: "absolute", "z-index": 20});
        ...
        if (f == 17) {
            ...
            a.find(".slotslide").each(function (t) {
                var o = e(this);
                TweenLite.fromTo(o, T / 800, {opacity: 0, rotationY: 0, scale: .9, rotationX: -110, transformPerspective: 600, transformOrigin: "center center"}, {opacity: 1, top: 0, left: 0, scale: 1, rotation: 0, rotationX: 0, rotationY: 0, ease: Power3.easeOut, delay: t * .06, onComplete: function () {
        ...
        if (f == 18) {
            ...
            a.find(".slotslide").each(function (t) {
                var o = e(this);
                TweenLite.fromTo(o, T / 500, {opacity: 0, rotationY: 310, scale: .9, rotationX: 10, transformPerspective: 600, transformOrigin: "center center"}, {opacity: 1, top: 0, left: 0, scale: 1, rotation: 0, rotationX: 0, rotationY: 0, ease: Power3.easeOut, delay: t * .06, onComplete: function () {
                    if (t == r.slots - 1)L(n, r, a, u, i, s)
                }})
            })
        }
        if (f == 19 || f == 22) {
            ...
            TweenLite.fromTo(a, T / 2e3, {transformPerspective: 600, z: 0, x: 0, rotationY: 0}, {rotationY: 1, ease: Power1.easeInOut, z: -40});
            TweenLite.fromTo(a, T / 2e3, {transformPerspective: 600, z: -40, rotationY: 1}, {rotationY: 0, z: 0, ease: Power1.easeInOut, x: 0, delay: 3 * (T / 4e3)});
            TweenLite.fromTo(u, T / 2e3, {transformPerspective: 600, z: 0, x: 0, rotationY: 0}, {rotationY: 1, x: 0, ease: Power1.easeInOut, z: -40});
            TweenLite.fromTo(u, T / 2e3, {transformPerspective: 600, z: -40, x: 0, rotationY: 1}, {rotationY: 0, z: 0, x: 0, ease: Power1.easeInOut, delay: 3 * (T / 4e3)});
            a.find(".slotslide").each(function (t) {
                var o = e(this);
                TweenLite.fromTo(o, T / 1e3, {left: 0, rotationY: r.rotate, opacity: F, top: 0, scale: .8, transformPerspective: 600, transformOrigin: st, rotationX: it}, {left: 0, rotationY: 0, opacity: 1, top: 0, z: 0, scale: 1, rotationX: 0, delay: t * 50 / 1e3, ease: Power2.easeInOut, onComplete: function () {
                    if (t == r.slots - 1)L(n, r, a, u, i, s)
                }});
            ...
            u.find(".slotslide").each(function (t) {
                ...
                var f = -90;
                if (x == 1)f = 90;
                TweenLite.fromTo(o, T / 1e3, {opacity: 1, rotationY: 0, top: 0, z: 0, scale: 1, transformPerspective: 600, transformOrigin: st, rotationX: 0}, {opacity: 1, rotationY: r.rotate, top: 0, scale: .8, rotationX: f, delay: t * 50 / 1e3, ease: Power2.easeInOut, onComplete: function () {
                    if (t == r.slots - 1)L(n, r, a, u, i, s)
                }});
        ...
        if (f == 20) {
            ...
            a.find(".slotslide").each(function (t) {
                var o = e(this);
                TweenLite.fromTo(o, T / 1500, {left: ot, rotationX: 40, z: -600, opacity: F, top: 0, transformPerspective: 600, transformOrigin: st, rotationY: it}, {left: 0, delay: t * 50 / 1e3, ease: Power2.easeInOut});
                TweenLite.fromTo(o, T / 1e3, {rotationX: 40, z: -600, opacity: F, top: 0, scale: 1, transformPerspective: 600, transformOrigin: st, rotationY: it}, {rotationX: 0, opacity: 1, top: 0, z: 0, scale: 1, rotationY: 0, delay: t * 50 / 1e3, ease: Power2.easeInOut, onComplete: function () {
                    if (t == r.slots - 1)L(n, r, a, u, i, s)
                }});
            ...
            u.find(".slotslide").each(function (t) {
                ...
                TweenLite.fromTo(o, T / 1e3, {opacity: 1, rotationX: 0, top: 0, z: 0, scale: 1, left: 0, transformPerspective: 600, transformOrigin: c, rotationY: 0}, {opacity: 1, rotationX: 40, top: 0, z: -600, left: f, scale: .8, rotationY: l, delay: t * 50 / 1e3, ease: Power2.easeInOut, onComplete: function () {
                    if (t == r.slots - 1)L(n, r, a, u, i, s)
                }});
                TweenLite.to(o, .1, {opacity: 0, delay: t * 50 / 1e3 + (T / 1e3 - T / 1e4)})
            })
        ...
        if (f == 21 || f == 25) {
            ...
            a.find(".slotslide").each(function (t) {
                var o = e(this);
                TweenLite.fromTo(o, T / 1500, {left: 0, rotationX: rot2, z: 0, opacity: 0, top: 0, scale: 1, transformPerspective: 600, transformOrigin: st, rotationY: it}, {left: 0, rotationX: 0, top: 0, z: 0, scale: 1, rotationY: 0, delay: t * 100 / 1e3 + T / 1e4, ease: Power2.easeInOut, onComplete: function () {
                    if (t == r.slots - 1)L(n, r, a, u, i, s)
                }});
            ...
            u.find(".slotslide").each(function (t) {
                var n = e(this);
                TweenLite.fromTo(n, T / 3e3, {left: 0, rotationX: 0, z: 0, opacity: 1, top: 0, scale: 1, transformPerspective: 600, transformOrigin: st, rotationY: 0}, {left: 0, rotationX: rot2, top: 0, z: 0, scale: 1, rotationY: it, delay: t * 100 / 1e3, ease: Power1.easeInOut});
        ...
        if (f == 23 || f == 24) {
            ...
            var ut = 0;
            TweenLite.fromTo(a, T / 2e3, {transformPerspective: 600, z: 0, x: 0, rotationY: 0}, {rotationY: 1, ease: Power1.easeInOut, z: -90});
            TweenLite.fromTo(a, T / 2e3, {transformPerspective: 600, z: -90, rotationY: 1}, {rotationY: 0, z: 0, ease: Power1.easeInOut, x: 0, delay: 3 * (T / 4e3)});
            TweenLite.fromTo(u, T / 2e3, {transformPerspective: 600, z: 0, x: 0, rotationY: 0}, {rotationY: 1, x: 0, ease: Power1.easeInOut, z: -90});
            TweenLite.fromTo(u, T / 2e3, {transformPerspective: 600, z: -90, x: 0, rotationY: 1}, {rotationY: 0, z: 0, x: 0, ease: Power1.easeInOut, delay: 3 * (T / 4e3)});
            a.find(".slotslide").each(function (t) {
                var o = e(this);
                TweenLite.fromTo(o, T / 1e3, {left: ut, rotationX: r.rotate, opacity: F, top: 0, scale: 1, transformPerspective: 600, transformOrigin: st, rotationY: it}, {left: 0, rotationX: 0, opacity: 1, top: 0, z: 0, scale: 1, rotationY: 0, delay: t * 50 / 1e3, ease: Power2.easeInOut, onComplete: function () {
                    if (t == r.slots - 1)L(n, r, a, u, i, s)
                }});
                TweenLite.to(o, .1, {opacity: 1, delay: t * 50 / 1e3 + T / 3e3})
            });
            ...
            u.find(".slotslide").each(function (t) {
                var o = e(this);
                TweenLite.fromTo(o, T / 1e3, {left: 0, opacity: 1, rotationX: 0, top: 0, z: 0, scale: 1, transformPerspective: 600, transformOrigin: st, rotationY: 0}, {left: ut, opacity: 1, rotationX: r.rotate, top: 0, scale: 1, rotationY: it, delay: t * 50 / 1e3, ease: Power2.easeInOut, onComplete: function () {
                    if (t == r.slots - 1)L(n, r, a, u, i, s)
                }});
                TweenLite.to(o, .1, {opacity: 0, delay: t * 50 / 1e3 + (T / 1e3 - T / 1e4)})
            })
            ...
            if (c == 0) {
                        ...
                        if (n.attr("src").toLowerCase().indexOf("youtube") >= 0) {
                                    ...
                                    var u = setInterval(function () {
                                        if (YT != t)if (typeof YT.Player != t && typeof YT.Player != "undefined") {
                                            if (a.data("autoplay") == true) {
                                                o = new YT.Player(h, {events: {onStateChange: A, onReady: function (e) {
                                                    e.target.playVideo()
                                                }}})
                                            } else o = new YT.Player(h, {events: {onStateChange: A}});
                            ...
                            if (n.attr("src").toLowerCase().indexOf("vimeo") >= 0) {
                                if (!n.hasClass("HasListener")) {
                                    ...
                                    if (c["player_id"] != t)l = l.replace(c["player_id"], h); else l = l + "&player_id=" + h;
                                    try {
                                    ...
                                    if (a.data("autoplay") == true) {
                                        ...
                                        var g = n.attr("id");
                                        var m = setInterval(function () {
                                            if ($f != t)if (typeof $f(g).api != t && typeof $f(g).api != "undefined") {
                                                var e = $f(g);
                                                a.data("timerplay", setTimeout(function () {
                        ...
                        a.find("video").each(function (n) {
                            ...
                            o.data("interval", setInterval(function () {
                                if (o.data("metaloaded") == 1 || s.duration != NaN) {
                                    clearInterval(o.data("interval"));
                                    if (a.data("dottedoverlay") != "none" && a.data("dottedoverlay") != t)if (a.find(".tp-dottedoverlay").length != 1)o.append('<div class="tp-dottedoverlay ' + a.data("dottedoverlay") + '"></div>');
                                    var n = 16 / 9;
                                    ...
                                    if (a.data("autoplay") == true || u == true) {
                                        ...
                                        if (a.data("forcerewind") == "on" && !o.hasClass("videoisplaying"))if (s.currentTime > 0)s.currentTime = 0;
                                        if (a.data("volume") == "mute")s.muted = true;
                ...
                if (a.find("img").length > 0) {
                    ...
                    if (a.find("iframe").length > 0 || a.find("video").length > 0) {
                        ...
                        if (!a.hasClass("fullscreenvideo"))a.css({"font-size": w.data("fsize") * r.bw + "px", "padding-top": w.data("pt") * r.bh + "px", "padding-bottom": w.data("pb") * r.bh + "px", "padding-left": w.data("pl") * r.bw + "px", "padding-right": w.data("pr") * r.bw + "px", "margin-top": w.data("mt") * r.bh + "px", "margin-bottom": w.data("mb") * r.bh + "px", "margin-left": w.data("ml") * r.bw + "px", "margin-right": w.data("mr") * r.bw + "px", "border-top": w.data("bt") * r.bh + "px", "border-bottom": w.data("bb") * r.bh + "px", "border-left": w.data("bl") * r.bw + "px", "border-right": w.data("br") * r.bw + "px", "line-height": w.data("lh") * r.bh + "px", height: y * r.bh + "px"}); else {
                            s = 0;
                            o = 0;
                            a.data("x", 0);
                            a.data("y", 0);
                        ...
                        a.find(".frontcorner").css({borderWidth: T + "px", left: 0 - T + "px", borderRight: "0px solid transparent", borderTopColor: N});
                        a.find(".frontcornertop").css({borderWidth: T + "px", left: 0 - T + "px", borderRight: "0px solid transparent", borderBottomColor: N});
                        a.find(".backcorner").css({borderWidth: T + "px", right: 0 - T + "px", borderLeft: "0px solid transparent", borderBottomColor: N});
                        a.find(".backcornertop").css({borderWidth: T + "px", right: 0 - T + "px", borderLeft: "0px solid transparent", borderTopColor: N})
                    }
                }
                ...
                if (a.data("x") == "center" || a.data("xcenter") == "center")var X = a.data("x") + s; else {
                    var X = f * a.data("x") + s
                }
                if (a.data("y") == "center" || a.data("ycenter") == "center")var V = a.data("y") + o; else {
                    var V = r.bh * a.data("y") + o
                }
                TweenLite.set(a, {top: V, left: X, overwrite: "auto"});
                if (u == 0)i = true;
                if (!i) {
                    if (a.data("timeline") != t)a.data("timeline").clear();
                    function J() {
                        setTimeout(function () {
                            a.css({transform: "none", "-moz-transform": "none", "-webkit-transform": "none"})
                        }, 100)
                    }

                    function K() {
                        a.data("timer", setTimeout(function () {
                            if (a.hasClass("fullscreenvideo"))a.css({display: "block"})
                        }, a.data("start")))
                    }

                    var Q = new TimelineLite({smoothChildTiming: true, onStart: K});
                    if (r.fullScreenAlignForce == "on") {
                    }
                    var G = a;
                    ...
                    if (a.data("splitin") == "chars" || a.data("splitin") == "words" || a.data("splitin") == "lines" || a.data("splitout") == "chars" || a.data("splitout") == "words" || a.data("splitout") == "lines") {
                        if (a.find("a").length > 0)a.data("mySplitText", new SplitText(a.find("a"), {type: "lines,words,chars", charsClass: "tp-splitted", wordsClass: "tp-splitted", linesClass: "tp-splitted"})); else a.data("mySplitText", new SplitText(a, {type: "lines,words,chars", charsClass: "tp-splitted", wordsClass: "tp-splitted", linesClass: "tp-splitted"}));
                        a.addClass("splitted")
                    }
                    ...
                    if (a.hasClass("customin"))Y = P(Y, a.data("customin")); else if (a.hasClass("randomrotate")) {
                    ...
                    } else if (a.hasClass("lfr") || a.hasClass("skewfromright"))Y.x = 15 + r.width; else if (a.hasClass("lfl") || a.hasClass("skewfromleft"))Y.x = -15 - d; else if (a.hasClass("sfl") || a.hasClass("skewfromleftshort"))Y.x = -50; else if (a.hasClass("sfr") || a.hasClass("skewfromrightshort"))Y.x = 50; else if (a.hasClass("lft"))Y.y = -25 - v; else if (a.hasClass("lfb"))Y.y = 25 + r.height; else if (a.hasClass("sft"))Y.y = -50; else if (a.hasClass("sfb"))Y.y = 50;
                    if (a.hasClass("skewfromright") || a.hasClass("skewfromrightshort"))Y.skewX = -85; else if (a.hasClass("skewfromleft") || a.hasClass("skewfromleftshort"))Y.skewX = 85;
                    ...
                    if (u != 2) {
                        if (a.hasClass("customin")) {
                            if (G != a)Q.add(TweenLite.set(a, {opacity: 1, scaleX: 1, scaleY: 1, rotationX: 0, rotationY: 0, rotationZ: 0, skewX: 0, skewY: 0, z: 0, x: 0, y: 0, visibility: "visible", opacity: 1, delay: 0, overwrite: "all"}));
                            Y.visibility = "hidden";
    ...
    var q = function (n, r) {
        n.find(".rs-pendulum").each(function () {
            ...
            if (n.data("timeline") == t) {
                ...
                i = i * r;
                s = s * r;
                n.data("timeline").append(new TweenLite.fromTo(n, speed, {rotation: i, transformOrigin: origin}, {rotation: s, ease: easing}));
                n.data("timeline").append(new TweenLite.fromTo(n, speed, {rotation: s, transformOrigin: origin}, {rotation: i, ease: easing, onComplete: function () {
        ...
        n.find(".rs-slideloop").each(function () {
            ...
            if (n.data("timeline") == t) {
                ...
                n.data("timeline").append(new TweenLite.fromTo(n, speed, {x: xe, y: ye}, {x: i, y: s, onComplete: function () {
                    n.data("timeline").restart()
                }}))
            }
        });
        ...
        n.find(".rs-wave").each(function () {
            ...
            if (n.data("timeline") == t) {
                ...
                n.data("timeline").append(new TweenLite.fromTo(a, o, {a: 360}, {a: 0, ease: Linear.easeNone, onUpdate: function () {
        ...
        if (r.slideamount > 1 && !(r.stopAfterLoops == 0 && r.stopAtSlide == 1)) {
            ...
            n.on("restarttimer", function () {
                if (r.stopLoop == "on" && r.next == r.lastslidetoshow - 1) {
                    ...
                    i.css({visibility: "visible"});
                    i.data("tween", TweenLite.fromTo(i, r.delay / 1e3, {width: "0%"}, {width: "100%", ease: Linear.easeNone, onComplete: s, delay: 1}))
                }
                if (r.hideTimerBar == "on")i.css({visibility: "hidden"})
            });
    ...
    var K = function (n, r, i, s) {
        ...
        l.find(".defaultimg").each(function () {
            ...
            if (s) {
                TweenLite.set(n, {autoAlpha: 0, transformPerspective: 1200, transformOrigin: "0% 0%", top: 0, left: 0, scale: i.w, x: i.x, y: i.y});
            ...
            } else t.data("kenburn", TweenLite.fromTo(n, w, {autoAlpha: 1, force3D: true, transformOrigin: "0% 0%", top: 0, left: 0, scale: i.w, x: i.x, y: i.y}, {autoAlpha: 1, rotationZ: m, ease: b, x: u.x, y: u.y, scale: u.w, onUpdate: function () {
    ...
    var Y = function (n, r) {
        ...
        n.find(".defaultimg").each(function () {
            ...
            if (n.data("currotate") != t && n.data("bgposition") != t && n.data("curscale") != t)TweenLite.set(n, {rotation: n.data("currotate"), backgroundPosition: n.data("bgposition"), backgroundSize: n.data("curscale")});
