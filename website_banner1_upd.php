...
?>
        ...
        <header class="panel-heading">
            <?=$hsm_name_08_031?> &gt; <?=$txt_web_banner1_03?>
        ...
        <div class="panel-body">
							...
							<div class="form">
                                <form class="cmxform form-horizontal adminex-form" name="signformnow" method="post" ENCTYPE="multipart/form-data" action="website_banner1_upd.php">
								...
								<input type='hidden' name='sorting_key' value='<?=$sorting_key?>'>
									...
									<div class="form-group ">
                                        <label for="cname" class="control-label col-sm-3"><?=$txt_web_banner1_13?></label>
                                        <div class="col-sm-6">
									...
									<div class="form-group ">
                                        ...
                                        <div class="col-sm-9">
                                            <?=$txt_web_banner1_111?> : <input type='text' name='b_width' value="<?=$b_width?>" maxlength=4 style='WIDTH: 80px; text-align: center'> <?=$txt_web_banner1_12?> *   
											<?=$txt_web_banner1_112?> : <input type='text' name='b_height' value="<?=$b_height?>" maxlength=4 style='WIDTH: 80px; text-align: center'> <?=$txt_web_banner1_12?>
                                        </div>
                                    </div>
									...
									<div class="form-group ">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" id="cname" name="b_memo" value="<?echo("$b_memo")?>" type="text" />
                                        </div>
                                    </div>
...
<?
  ...
  if($userfile != "") {
			...
			$new_filename = "banner_"."$old_b_id".".{$extension2}";
			...
			// Database Update
			$query = "UPDATE wpage_banner1 SET b_width = '$b_width', b_height = '$b_height', memo = '$b_memo', b_type = '$image_type', 
					filesize = '$userfile_size' WHERE uid = '$uid' AND gate = '$key_gate' AND branch_code = '$login_branch'";

  } else {

			// Database Update
			$query = "UPDATE wpage_banner1 SET b_width = '$b_width', b_height = '$b_height', memo = '$b_memo' 
