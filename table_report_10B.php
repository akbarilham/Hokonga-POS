...
<section id="container" class="">
      ...
      <section id="main-content">
        ...
        <div class="panel-body">
			...
			<div class='col-sm-4'>
				...
				for($gu = 0; $gu < $total_guc; $gu++) {
					...
					echo ("<option disabled value='$link_list_branch' $slc_branch>$k_branch_name</option>");
							...
							$query_sh1 = "SELECT shop_code,shop_name FROM client_shop WHERE branch_code = '$k_branch_code' AND associate = '1' AND shop_type = 'off' ORDER BY shop_code ASC";
			...
			if($mode) {
				$main_module = "wms_totalstock.inc";
				#$main_module = "";
			} else {
