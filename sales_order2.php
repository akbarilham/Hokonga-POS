...
$link_list = "$home/sales_order2.php?sorting_key=$sorting_key&key_shop=$key_shop";
$link_upd = "$home/sales_order2.php?sorting_key=$sorting_key&key_shop=$key_shop&keyfield=$keyfield&key=$key&page=$page";
...
?>
			...
			<div class="col-sm-2">
				...
				echo ("
				<form name='product_update_all' method='post' action='sales_order2.php'>
      ...
      // 합계
      echo ("
      <form name='order_check' method='post' action='sales_order2.php'>
	  ...
	  if($smode == "order_confirm") {
		...
		echo ("
		<form name='order_check' class='cmxform form-horizontal adminex-form' method='post' action='sales_order2.php'>
	  ...
	  <input type=hidden name='stat' value='$stat'>
		...
		<div class='form-group'>
            ...
            <div class='col-sm-4'>");
			   if (isset($_POST['new_buyer_name'])) {
           $new_buyer_name = $_POST['new_buyer_name'];
         }
...
<?
  ...
  if($add_mode == "update_all") { // 모든 상품 업데이트
      ...
      // 리스트로 돌아가기
      echo("<meta http-equiv='Refresh' content='10; URL=$home/sales_order2.php?sorting_key=$sorting_key&key_shop=$key_shop&keyfield=$keyfield&key=$key&page=$page'>");
      exit;
