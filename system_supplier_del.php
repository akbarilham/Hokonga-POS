...
$query = "SELECT uid,branch_code,gate,supp_code,supp_name,supp_type,manager,email,homepage,phone1,phone2,phone_fax,
          phone_cell,addr1,addr2,zipcode,userlevel,signdate,memo,currency FROM client_supplier WHERE uid = '$uid'";
...
?>
        ...
        <div class="panel-body">
							...
							<div class="form">
                                <form class="cmxform form-horizontal adminex-form" name="signformnow" method="post" action="system_supplier_del.php">
								...
								<input type='hidden' name='user_uid' value="<?=$shop_uid?>">
									...
									<div class="form-group ">
                                        ...
                                        <div class="col-sm-2">
                                            <input readonly class="form-control" id="cname" name="dis_shop_code" value="<?=$shop_code?>" type="text" required />
                                        </div>
                                    </div>
...
<?
	...
	$query  = "DELETE FROM client_supplier WHERE uid = '$user_uid'"; 
	$result = mysql_query($query);
