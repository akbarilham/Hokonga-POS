...
$link_list = "$home/inventory_opname_ini2.php";
$link_list_action = "$home/inventory_opname_ini2.php?sorting_key=$sorting_key&keyfield=$keyfield&key=$key&keyA=$keyA&keyB=$keyB&keyC=$keyC&keyD=$keyD&key1=$key1&key2=$key2&key3=$key3&page=$page&mode=upd&view=qty";

$link_post = "$home/inventory_opname_ini2.php?mode=post&sorting_key=$sorting_key&keyfield=$keyfield&key=$key&keyA=$keyA&keyB=$keyB&keyC=$keyC&keyD=$keyD&key1=$key1&key2=$key2&key3=$key3&page=$page";
$link_post_catg = "$home/inventory_opname_ini2.php?mode=post_catg&sorting_key=$sorting_key&keyfield=$keyfield&key=$key&keyA=$keyA&keyB=$keyB&keyC=$keyC&keyD=$keyD&key1=$key1&key2=$key2&key3=$key3&page=$page";
?>
		...
		if($keyC) {
			if($keyD) {
				...
				if($key1) {
					if($key2) {
						if($key3) {
							$sorting_filter = "branch_code = '$keyA' AND brand_code = '$keyB' AND gudang_code = '$keyC' AND shop_code LIKE 'B%' AND catg_code = '$key3'";
						} else {
							$sorting_filter = "branch_code = '$keyA' AND brand_code = '$keyB' AND gudang_code = '$keyC' AND shop_code LIKE 'B%' AND catg_code LIKE '$key2%'";
						}
					} else {
							$sorting_filter = "branch_code = '$keyA' AND brand_code = '$keyB' AND gudang_code = '$keyC' AND shop_code LIKE 'B%' AND catg_code LIKE '$key1%'";
					}
				} else {
							$sorting_filter = "branch_code = '$keyA' AND brand_code = '$keyB' AND gudang_code = '$keyC' AND shop_code LIKE 'B%' AND catg_code != ''";
				}
			}
		} else {
			if($keyD) {
				...
				if($key1) {
					if($key2) {
						if($key3) {
							$sorting_filter = "branch_code = '$keyA' AND brand_code = '$keyB' AND shop_code LIKE 'B%' AND catg_code = '$key3'";
						} else {
							$sorting_filter = "branch_code = '$keyA' AND brand_code = '$keyB' AND shop_code LIKE 'B%' AND catg_code LIKE '$key2%'";
						}
					} else {
							$sorting_filter = "branch_code = '$keyA' AND brand_code = '$keyB' AND shop_code LIKE 'B%' AND catg_code LIKE '$key1%'";
					}
				} else {
							$sorting_filter = "branch_code = '$keyA' AND brand_code = '$keyB' AND shop_code LIKE 'B%' AND catg_code != ''";
				}
			}
		}
	} else {
		if($keyC) {
			if($keyD) {
				...
				if($key1) {
					if($key2) {
						if($key3) {
							$sorting_filter = "branch_code = '$keyA' AND gudang_code = '$keyC' AND shop_code LIKE 'B%' AND catg_code = '$key3'";
						} else {
							$sorting_filter = "branch_code = '$keyA' AND gudang_code = '$keyC' AND shop_code LIKE 'B%' AND catg_code LIKE '$key2%'";
						}
					} else {
							$sorting_filter = "branch_code = '$keyA' AND gudang_code = '$keyC' AND shop_code LIKE 'B%' AND catg_code LIKE '$key1%'";
					}
				} else {
							$sorting_filter = "branch_code = '$keyA' AND gudang_code = '$keyC' AND shop_code LIKE 'B%' AND catg_code != ''";
				}
			}
		} else {
			if($keyD) {
				...
				if($key1) {
					if($key2) {
						if($key3) {
							$sorting_filter = "branch_code = '$keyA' AND shop_code LIKE 'B%' AND catg_code = '$key3'";
						} else {
							$sorting_filter = "branch_code = '$keyA' AND shop_code LIKE 'B%' AND catg_code LIKE '$key2%'";
						}
					} else {
							$sorting_filter = "branch_code = '$keyA' AND shop_code LIKE 'B%' AND catg_code LIKE '$key1%'";
					}
				} else {
							$sorting_filter = "branch_code = '$keyA' AND shop_code LIKE 'B%' AND catg_code != ''";
				}
			}
		}
	}
		...
		if($keyC) {
			if($keyD) {
				...
				if($key1) {
					if($key2) {
						if($key3) {
							$sorting_filter = "brand_code = '$keyB' AND gudang_code = '$keyC' AND shop_code LIKE 'B%' AND catg_code = '$key3'";
						} else {
							$sorting_filter = "brand_code = '$keyB' AND gudang_code = '$keyC' AND shop_code LIKE 'B%' AND catg_code LIKE '$key2%'";
						}
					} else {
							$sorting_filter = "brand_code = '$keyB' AND gudang_code = '$keyC' AND shop_code LIKE 'B%' AND catg_code LIKE '$key1%'";
					}
				} else {
							$sorting_filter = "brand_code = '$keyB' AND gudang_code = '$keyC' AND shop_code LIKE 'B%' AND catg_code != ''";
				}
			}
		} else {
			if($keyD) {
				...
				if($key1) {
					if($key2) {
						if($key3) {
							$sorting_filter = "brand_code = '$keyB' AND shop_code LIKE 'B%' AND catg_code = '$key3'";
						} else {
							$sorting_filter = "brand_code = '$keyB' AND shop_code LIKE 'B%' AND catg_code LIKE '$key2%'";
						}
					} else {
							$sorting_filter = "brand_code = '$keyB' AND shop_code LIKE 'B%' AND catg_code LIKE '$key1%'";
					}
				} else {
							$sorting_filter = "brand_code = '$keyB' AND shop_code LIKE 'B%' AND catg_code != ''";
				}
			}
		}
	} else {
		if($keyC) {
			if($keyD) {
				...
				if($key1) {
					if($key2) {
						if($key3) {
							$sorting_filter = "gudang_code = '$keyC' AND shop_code LIKE 'B%' AND catg_code = '$key3'";
						} else {
							$sorting_filter = "gudang_code = '$keyC' AND shop_code LIKE 'B%' AND catg_code LIKE '$key2%'";
						}
					} else {
							$sorting_filter = "gudang_code = '$keyC' AND shop_code LIKE 'B%' AND catg_code LIKE '$key1%'";
					}
				} else {
							$sorting_filter = "gudang_code = '$keyC' AND shop_code LIKE 'B%' AND catg_code != ''";
				}
			}
		} else {
			if($keyD) {
				...
				if($key1) {
					if($key2) {
						if($key3) {
							$sorting_filter = "shop_code LIKE 'B%' AND catg_code = '$key3'";
						} else {
							$sorting_filter = "shop_code LIKE 'B%' AND catg_code LIKE '$key2%'";
						}
					} else {
							$sorting_filter = "shop_code LIKE 'B%' AND catg_code LIKE '$key1%'";
					}
				} else {
							$sorting_filter = "shop_code LIKE 'B%' AND catg_code != ''";
				}
			}
		}
	}
...
?>
        ...
        <header class="panel-heading">
            <?=$hsm_name_02_022?> &nbsp;&nbsp; - <?=$txt_sys_shop_071?>
        ...
        <div class="panel-body">
			...
			<div class='col-sm-4'>
				...
				for($gu = 0; $gu < $total_guc; $gu++) {
					...
					echo ("<option disabled value='$link_list_branch' $slc_branch>$k_branch_name</option>");
							...
							$query_sh1c = "SELECT count(uid) FROM client_shop WHERE branch_code = '$k_branch_code' AND associate = '0' AND shop_type = 'off'";
							$result_sh1c = mysql_query($query_sh1c);
								if (!$result_sh1c) {   error("QUERY_ERROR");   exit; }
    
							$total_sh1c = @mysql_result($result_sh1c,0,0);
							
							$query_sh1 = "SELECT shop_code,shop_name FROM client_shop WHERE branch_code = '$k_branch_code' AND associate = '0' AND shop_type = 'off' 
			...
			<?
			echo ("
			<form name='search1' method='post' action='inventory_opname_ini2.php'>
			<div class='col-sm-2'>
			...
			<form name='search2' method='post' action='inventory_opname_ini2.php'>
...
<tr height=22>
   ...
   <td><b>{$prd_tsmS2_qty_now_K}</b> ( $prd_tcS1_qty_in_K items )</td>
</tr>
");
			...
			echo ("
			<form name='qs_signform' method='post' action='inventory_opname_ini2.php'>
...
// Total Count ---------------------------------------------------- //
if(!eregi("[^[:space:]]+",$key)) {
  $query = "SELECT count(uid) FROM shop_stock_list WHERE $sorting_filter";
} else {
  $encoded_key = urlencode($key);
  $query = "SELECT count(uid) FROM shop_stock_list WHERE $sorting_filter AND $keyfield LIKE '%$key%'";  
}
$result = mysql_query($query);
if (!$result) {
   error("QUERY_ERROR");
...
for($i = $first; $i <= $last; $i++) {
	...
	$qty_sum2dt = @mysql_result($result_cnt2dt,0,1);
		...
		if($qty_cnt1dt > 0) {
				...
				$result_W = mysql_query("UPDATE shop_product_list_qty SET stock = '$new_qty_now[$li_uid]', date = '$post_dates', date = '$check_dates', 
							org_uid = '$li_uid', branch_code = '$keyA', gudang_code = '$keyC', virtual = '0' WHERE uid = '$max_uiddt_g'");
				...
				$result_U1 = mysql_query("UPDATE shop_product_list_qty SET stock = '$new_qty_now[$li_uid]', date = '$post_dates', date = '$check_dates', 
							org_uid = '$li_uid', branch_code = '$keyA', gudang_code = '$keyC', virtual = '0' WHERE uid = '$max_uid1dt'");
				...
				if($qty_cnt2dt > 0) {
					...
					$result_U2 = mysql_query("UPDATE shop_product_list_shop SET qty_org = '$new_qty_now[$li_uid]', qty_now = '$new_qty_now[$li_uid]', 
							store_date = '$check_dates', org_uid = '$li_uid', branch_code = '$keyA', gudang_code = '$keyC', ini = '1' 
							WHERE uid = '$max_uid2dt_s'");
					if(!$result_U2) { error("QUERY_ERROR"); exit; }
				
				} else {
					
					$query_U3 = "INSERT INTO shop_product_list_shop (uid,branch_code,catg_code,brand_code,shop_code,gcode,pcode,org_pcode,org_barcode,
							qty_org,qty_now,store_date,ini) values ('','$keyA','$li_catg_code','$li_brand_code','$keyD','$li_gcode','$li_pcode','$li_org_pcode',
				...
				$query_WH = "INSERT INTO shop_product_list_qty (uid,org_uid,flag,branch_code,supp_code,shop_code,gudang_code,
				...
				$query_SH1 = "INSERT INTO shop_product_list_qty (uid,org_uid,flag,branch_code,supp_code,shop_code,gudang_code,
						catg_code,brand_code,gcode,pcode,org_pcode,org_barcode,stock,stock_check,stock_loss,date,check_date,virtual,ini) 
						values ('','$li_uid','out','$keyA','$li_supp_code','$keyD','$keyC','$li_catg_code','$li_brand_code','$li_gcode','$li_pcode','$li_org_pcode',
						'$li_org_barcode','$new_qty_now[$li_uid]','0','0','$post_dates','$post_dates','0','1')";
				$result_SH1 = mysql_query($query_SH1);
				if (!$result_SH1) { error("QUERY_ERROR"); exit; }
   ...
   $article_num--;
	...
	echo("<meta http-equiv='Refresh' content='0; URL=$home/inventory_opname_ini2.php?mode=upd&sorting_key=$sorting_key&keyfield=$keyfield&key=$key&keyA=$keyA&keyB=$keyB&keyC=$keyC&keyD=$keyD&key1=$key1&key2=$key2&key3=$key3&page=$page'>");
	exit;
