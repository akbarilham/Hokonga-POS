...
$link_list = "$home/inventory_closing_check.php";
...
?>
        ...
        <header class="panel-heading">
           Inventory - Stock Closing Check (<?=$total_record?>)
        ...
        <div class="panel-body">
			...
			echo ("
			<form name='search' method='post' action='inventory_closing_check.php'>
			<div class='col-sm-3'>
		...
		<div class='col-sm-9'>
				...
				for($i2 = $first; $i2 <= $last; $i2++) {
					...
					$num2 = sprintf("%02d", $i2);
					if ($i2 == 7 and $i2 == 6 ){
							 $query2 = "SELECT stock_end
                                FROM shop_product_list_qty_2015{$num2} where date = '2015{$num2}'";
		                        ...
		                        $stocks = mysql_result($result2,$i2,0);
		                       
		                       
					echo ("<tr>");
					echo ("<td style='border: 1px solid #DEDEDE;'><div style='width: 40px;'>$stocks</div></td>");
					echo ("</tr>");
					}
				}
				?>
