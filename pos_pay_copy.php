...
$sales_code = mysql_result($fetch_kassier_2,0,1);
...
$fetch_fin = mysql_query($query_fin);
...
$fetch_del = mysql_query($query_del);
...
$fetch_del2 = mysql_query($query_del2);
