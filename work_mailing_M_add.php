...
if($rmode == "1") {
	$query_dbm = "UPDATE member_staff SET crmflag = '1' WHERE uid = '$uid' AND branch_code = '$login_branch'";
} else {
	$query_dbm = "UPDATE member_main SET crmflag = '1' WHERE uid = '$uid' AND branch_code = '$login_branch'";
}
