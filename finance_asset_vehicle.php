...
<?
  ...
  $new_p_detail = addslashes($new_p_detail);
    ...
    if($new_del_chk == "1") { // Delete
        ...
        $result_CHG1 = mysql_query("UPDATE asset SET gate = '$new_gate', shop_code = '$new_shop_code', 
		...
		if($new_p_type == "2") { // Vehicle
			...
			$result_CHG2 = mysql_query("UPDATE asset_list_vehicle SET gate = '$new_gate', shop_code = '$new_shop_code', 
  ...
  $m_ip = getenv('REMOTE_ADDR');
	...
	if($new_p_type == "2") { // Vehicle
		...
		$query_F2 = "INSERT INTO asset_list_vehicle (uid,branch_code,gate,shop_code,p_code,p_name) values ('',
			'$login_branch','$new_gate','$new_shop_code','$new_p_code','$new_p_name')";
