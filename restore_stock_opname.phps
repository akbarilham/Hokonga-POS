...
?>
        ...
        <div class="panel-body">
							...
							<div class="form">
                                <form class="cmxform form-horizontal adminex-form" name="signformnow" method="post" action="restore_stock_opname.php">
								...
								<input type='hidden' name='mb_type' value='<?=$mb_type?>'>
									...
									<div class="form-group ">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" id="cname" name="data_name" type="text" value="table_stock_201507_cvj2" />
                                        </div>
                                    </div>
...
<?
	...
	if($job_slct == "4") {
		...
		echo("<meta http-equiv='Refresh' content='0; URL=$home/restore_stock_opname.php'>");
		exit;
		...
		for($ra = 0; $ra < $total_recordC2; $ra++) {
			...
			if($r)
				...
				// SUM *
				$result_sum = mysql_query("UPDATE shop_product_list SET stock_now = '$rest' WHERE org_pcode = '$R_pcode'");
					...
					if($sp_opt1[$o1] > 0) {
						...
						if($num > 537) { // WH
							...
							$query_SH3 = "INSERT INTO shop_product_list_qty (uid,org_uid,flag,branch_code,supp_code,shop_code,gudang_code,
									...
									'$sp_opt1[$o1]','0','0','$post_dates','$post_dates','0','1')";
							$result_SH3 = mysql_query($query_SH3);
							if (!$result_SH3) { error("QUERY_ERROR"); exit; }
							...
							$query_SH2 = "INSERT INTO shop_product_list_shop (uid,branch_code,catg_code,brand_code,group_code,shop_code,
								...
								'$li_gcode','$li_pcode','$R_pcode','$li_org_barcode','$li_gname','$li_pname','$sp_opt1[$o1]','$sp_opt1[$o1]','$post_dates','1')";
