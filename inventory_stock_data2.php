...
$link_list = "$home/inventory_stock_data2.php";
$link_list_action = "$home/inventory_stock_data2.php?sorting_key=$sorting_key&keyfield=$keyfield&key=$key&keyA=$keyA&keyB=$keyB&keyC=$keyC&keyD=$keyD&key1=$key1&key2=$key2&key3=$key3&page=$page&mode=upd&view=qty";
$link_post = "$home/inventory_stock_data2.php?mode=post&sorting_key=$sorting_key&keyfield=$keyfield&key=$key&keyA=$keyA&keyB=$keyB&keyC=$keyC&keyD=$keyD&key1=$key1&key2=$key2&key3=$key3&page=$page";
?>
		...
		if($keyC) {
			if($keyD) {
				...
				if($key1) {
					if($key2) {
						if($key3) {
							$sorting_filter = "branch_code = '$keyA' AND brand_code = '$keyB' AND gudang_code = '$keyC' AND shop_code = '' AND catg_code = '$key3'";
						} else {
							$sorting_filter = "branch_code = '$keyA' AND brand_code = '$keyB' AND gudang_code = '$keyC' AND shop_code = '' AND catg_code LIKE '$key2%'";
						}
					} else {
							$sorting_filter = "branch_code = '$keyA' AND brand_code = '$keyB' AND gudang_code = '$keyC' AND shop_code = '' AND catg_code LIKE '$key1%'";
					}
				} else {
							$sorting_filter = "branch_code = '$keyA' AND brand_code = '$keyB' AND gudang_code = '$keyC' AND shop_code = '' AND catg_code != ''";
				}
			}
		} else {
			if($keyD) {
				...
				if($key1) {
					if($key2) {
						if($key3) {
							$sorting_filter = "branch_code = '$keyA' AND brand_code = '$keyB' AND shop_code = '' AND catg_code = '$key3'";
						} else {
							$sorting_filter = "branch_code = '$keyA' AND brand_code = '$keyB' AND shop_code = '' AND catg_code LIKE '$key2%'";
						}
					} else {
							$sorting_filter = "branch_code = '$keyA' AND brand_code = '$keyB' AND shop_code = '' AND catg_code LIKE '$key1%'";
					}
				} else {
							$sorting_filter = "branch_code = '$keyA' AND brand_code = '$keyB' AND shop_code = '' AND catg_code != ''";
				}
			}
		}
	} else {
		if($keyC) {
			if($keyD) {
				...
				if($key1) {
					if($key2) {
						if($key3) {
							$sorting_filter = "branch_code = '$keyA' AND gudang_code = '$keyC' AND shop_code = '' AND catg_code = '$key3'";
						} else {
							$sorting_filter = "branch_code = '$keyA' AND gudang_code = '$keyC' AND shop_code = '' AND catg_code LIKE '$key2%'";
						}
					} else {
							$sorting_filter = "branch_code = '$keyA' AND gudang_code = '$keyC' AND shop_code = '' AND catg_code LIKE '$key1%'";
					}
				} else {
							$sorting_filter = "branch_code = '$keyA' AND gudang_code = '$keyC' AND shop_code = '' AND catg_code != ''";
				}
			}
		} else {
			if($keyD) {
				...
				if($key1) {
					if($key2) {
						if($key3) {
							$sorting_filter = "branch_code = '$keyA' AND shop_code = '' AND catg_code = '$key3'";
						} else {
							$sorting_filter = "branch_code = '$keyA' AND shop_code = '' AND catg_code LIKE '$key2%'";
						}
					} else {
							$sorting_filter = "branch_code = '$keyA' AND shop_code = '' AND catg_code LIKE '$key1%'";
					}
				} else {
							$sorting_filter = "branch_code = '$keyA' AND shop_code = '' AND catg_code != ''";
				}
			}
		}
	}
		...
		if($keyC) {
			if($keyD) {
				...
				if($key1) {
					if($key2) {
						if($key3) {
							$sorting_filter = "brand_code = '$keyB' AND gudang_code = '$keyC' AND shop_code = '' AND catg_code = '$key3'";
						} else {
							$sorting_filter = "brand_code = '$keyB' AND gudang_code = '$keyC' AND shop_code = '' AND catg_code LIKE '$key2%'";
						}
					} else {
							$sorting_filter = "brand_code = '$keyB' AND gudang_code = '$keyC' AND shop_code = '' AND catg_code LIKE '$key1%'";
					}
				} else {
							$sorting_filter = "brand_code = '$keyB' AND gudang_code = '$keyC' AND shop_code = '' AND catg_code != ''";
				}
			}
		} else {
			if($keyD) {
				...
				if($key1) {
					if($key2) {
						if($key3) {
							$sorting_filter = "brand_code = '$keyB' AND shop_code = '' AND catg_code = '$key3'";
						} else {
							$sorting_filter = "brand_code = '$keyB' AND shop_code = '' AND catg_code LIKE '$key2%'";
						}
					} else {
							$sorting_filter = "brand_code = '$keyB' AND shop_code = '' AND catg_code LIKE '$key1%'";
					}
				} else {
							$sorting_filter = "brand_code = '$keyB' AND shop_code = '' AND catg_code != ''";
				}
			}
		}
	} else {
		if($keyC) {
			if($keyD) {
				...
				if($key1) {
					if($key2) {
						if($key3) {
							$sorting_filter = "gudang_code = '$keyC' AND shop_code = '' AND catg_code = '$key3'";
						} else {
							$sorting_filter = "gudang_code = '$keyC' AND shop_code = '' AND catg_code LIKE '$key2%'";
						}
					} else {
							$sorting_filter = "gudang_code = '$keyC' AND shop_code = '' AND catg_code LIKE '$key1%'";
					}
				} else {
							$sorting_filter = "gudang_code = '$keyC' AND shop_code = '' AND catg_code != ''";
				}
			}
		} else {
			if($keyD) {
				...
				if($key1) {
					if($key2) {
						if($key3) {
							$sorting_filter = "shop_code = '' AND catg_code = '$key3'";
						} else {
							$sorting_filter = "shop_code = '' AND catg_code LIKE '$key2%'";
						}
					} else {
							$sorting_filter = "shop_code = '' AND catg_code LIKE '$key1%'";
					}
				} else {
							$sorting_filter = "shop_code = '' AND catg_code != ''";
				}
			}
		}
	}
...
?>
        ...
        <header class="panel-heading">
            <?=$txt_sales_sales_01?> (<?=$txt_sys_shop_079?>)
        ...
        <div class="panel-body">
			...
			<?
			echo ("
			<form name='search1' method='post' action='inventory_stock_data2.php'>
			<div class='col-sm-2'>
			...
			<form name='search2' method='post' action='inventory_stock_data2.php'>
        ...
        <tr>
			...
			<th colspan=2><?=$txt_invn_stockin_05?></th>
			...
			if($keyC) {
				...
				if($keyA) {
					$query_gc = "SELECT count(uid) FROM code_gudang WHERE branch_code = '$keyA' AND userlevel > '0'";
				} else {
					$query_gc = "SELECT count(uid) FROM code_gudang WHERE branch_code != 'CORP_01' AND userlevel > '0'";
				}
				...
				if($keyA) {
					$query_g = "SELECT branch_code,gudang_code,gudang_name FROM code_gudang WHERE branch_code = '$keyA' AND userlevel > '0' ORDER BY gudang_code ASC";
				} else {
					$query_g = "SELECT branch_code,gudang_code,gudang_name FROM code_gudang WHERE branch_code != 'CORP_01' AND userlevel > '0' ORDER BY branch_code ASC, gudang_code ASC";
				}
				...
				for($g = 0; $g < $total_gc; $g++) {
					...
					$g_gudang_code = mysql_result($result_g,$g,1);
					$g_gudang_name = mysql_result($result_g,$g,2);
					
					$link_list_g = "$link_list?sorting_key=$sorting_key&keyfield=$keyfield&key=$key&keyA=$g_branch_code&keyB=$keyB&keyC=$g_gudang_code&keyD=$keyD&key1=$key1&key2=$key2&key3=$key3";
							
					echo ("<th><a href='$link_list_g'><b>$g_gudang_name</b></a></th>");
...
$prd_grand_total_stock = $prd_tsmW2_qty_now + $prv_stock_end;
...
echo ("
<tr height=22>
   <td colspan=6 align=right><b>$txt_invn_stockin_74</b></td>");
	...
	<td align=right>{$prd_tsmW2_qty_now_K}</td>
	...
	");
				...
				// Total
				$query_gsum = "SELECT sum(stock_end) FROM final_monthly_stock WHERE $sorting_filter AND shop_code = '' AND date = '$ym1_date'";
				$result_gsum = mysql_query($query_gsum);
					if (!$result_gsum) { error("QUERY_ERROR"); exit; }
				$prd_gsum_now = @mysql_result($result_gsum,0,0);
				
				
				$query_gsum1 = "SELECT sum(stock) FROM shop_product_list_qty WHERE $sorting_filter AND flag = 'in' AND shop_code = ''";
				...
				$query_gsum2 = "SELECT sum(stock) FROM shop_product_list_qty WHERE $sorting_filter AND flag = 'out' AND shop_code != ''";
				...
				for($g = 0; $g < $total_gc; $g++) {
					...
					// SUM
					$query_tsum = "SELECT sum(stock_end) FROM final_monthly_stock 
								WHERE $sorting_filter AND shop_code = '' AND gudang_code = '$g_gudang_code' AND date = '$ym1_date'";
					...
					$query_tsum1 = "SELECT sum(stock) FROM shop_product_list_qty 
								WHERE $sorting_filter AND flag = 'in' AND shop_code = '' AND gudang_code = '$g_gudang_code'";
					...
					$query_tsum2 = "SELECT sum(stock) FROM shop_product_list_qty 
								WHERE $sorting_filter AND flag = 'out' AND shop_code != '' AND gudang_code = '$g_gudang_code'";
...
for($i = $first; $i <= $last; $i++) {
   ...
   $H_gcode = mysql_result($result,$i,11);
    ...
    // Stock of Begining
	$query_sub1 = "SELECT sum(stock_end) FROM final_monthly_stock WHERE pcode = '$H_pcode' AND date = '$ym1_date' AND shop_code = '' AND $sorting_filter";
    ...
    // 해당 상품코드의 수량 추출 [입고]
    $query_sub1 = "SELECT sum(stock) FROM shop_product_list_qty WHERE pcode = '$H_pcode' AND flag = 'in' AND shop_code = '' AND $sorting_filter";
    $result_sub1 = mysql_query($query_sub1);
    ...
    // 해당 상품코드의 수량 추출 [출고]
    $query_sub2 = "SELECT sum(stock) FROM shop_product_list_qty WHERE pcode = '$H_pcode' AND flag = 'out' AND shop_code != '' AND $sorting_filter";
  ...
  echo ("<tr>");
	...
	if($keyC) {
		echo("<td colspan=2 bgcolor='$highlight_color'><a href='$link_list_action&mode=upd&uid=$H_uid&view=qty'>{$H_pname}</a></td>");
	} else {
		echo("<td colspan=2 bgcolor='$highlight_color'>{$H_pname}</td>");
	}
	...
	if($keyC) {
		...
		echo ("<td align=right>{$sum_qty_now_K}</td>");
				...
				for($g = 0; $g < $total_gc; $g++) {
					...
					// SUM
					$query_sum = "SELECT sum(stock_end) FROM final_monthly_stock 
								WHERE $sorting_filter AND gudang_code = '$g_gudang_code' AND shop_code = '' AND pcode = '$H_pcode' AND date = '$ym1_date'";
					$result_sum = mysql_query($query_sum);
						if (!$result_sum) { error("QUERY_ERROR"); exit; }
					$prd_sum_qty = @mysql_result($result_sum,0,0);
						$prd_sum_qty_K = number_format($prd_sum_qty);
						
						
					$query_sum1 = "SELECT sum(stock) FROM shop_product_list_qty 
								WHERE $sorting_filter AND flag = 'in' AND gudang_code = '$g_gudang_code' AND shop_code = '' AND pcode = '$H_pcode'";
					...
					$query_sum2 = "SELECT sum(stock) FROM shop_product_list_qty 
								WHERE $sorting_filter AND flag = 'out' AND gudang_code = '$g_gudang_code' AND shop_code != '' AND pcode = '$H_pcode'";
					...
					$prd_sum3_qty = $prd_sum_qty + $prd_tsum1_qty - $prd_sum2_qty; // Stock
  ...
  echo("</tr>");
      ...
      if($view == "qty" AND $uid == "$H_uid") {
        ...
        $query_qs2 = "SELECT uid,stock,date,flag,pay_num,gudang_code,supp_code,shop_code,org_uid,date 
                      FROM shop_product_list_qty WHERE pcode = '$H_pcode' AND gudang_code = '$keyC' ORDER BY date ASC, flag ASC, shop_code ASC";
        ...
        for($qs = 0; $qs < $total_qs; $qs++) {
          ...
          echo ("
          <tr height=22>
            <form name='qs_signform' method='post' action='inventory_stock_data2.php'>
            ...
            echo ("
            <td align=center><input type=submit value='+/-' style='WIDTH: 35px' class='btn btn-default btn-xs'></td>
            </form>
...
<?
	...
	$post_dates = "$post_date1"."$post_date2";
		...
		echo("<meta http-equiv='Refresh' content='0; URL=$home/inventory_stock_data2.php?sorting_key=$sorting_key&keyfield=$keyfield&key=$key&keyA=$keyA&keyB=$keyB&keyC=$keyC&keyD=$keyD&key1=$key1&key2=$key2&key3=$key3&page=$page&mode=upd&view=qty&uid=$new_uid'>");
		exit;
