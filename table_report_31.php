      ...
      <section id="main-content">
        ...
        <div class="panel-body">
			...
			<div class='col-sm-4'>
				...
				// Report Subjects
				if($mode == "3101") {
					echo ("<option value='$PHP_SELF?keyA=$keyA&keyB=$keyB&mode=3101&p_year=$p_year&p_month=$p_month&p_yearmonth=$p_yearmonth' selected>$title_report_3101</a></option>");
				} else {
					echo ("<option value='$PHP_SELF?keyA=$keyA&keyB=$keyB&mode=3101&p_year=$p_year&p_month=$p_month&p_yearmonth=$p_yearmonth'>$title_report_3101</a></option>");
				}
			...
			if($mode) {
				...
				$main_module = "div_report_3101.inc";
			}
