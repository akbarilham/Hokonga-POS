      ...
      <section id="main-content">
        ...
        <div class="panel-body">
			...
			<div class='col-sm-4'>
				...
				// Report Subjects
				if($mode == "0401") {
					echo ("<option value='$PHP_SELF?keyA=$keyA&keyB=$keyB&mode=0401&p_year=$p_year&p_month=$p_month&p_yearmonth=$p_yearmonth' selected>$title_report_0401</a></option>");
				} else {
					echo ("<option value='$PHP_SELF?keyA=$keyA&keyB=$keyB&mode=0401&p_year=$p_year&p_month=$p_month&p_yearmonth=$p_yearmonth'>$title_report_0401</a></option>");
				}
				if($mode == "0402") {
					echo ("<option value='$PHP_SELF?keyA=$keyA&keyB=$keyB&mode=0402&p_year=$p_year&p_month=$p_month&p_yearmonth=$p_yearmonth' selected>$title_report_0402</a></option>");
				} else {
					echo ("<option value='$PHP_SELF?keyA=$keyA&keyB=$keyB&mode=0402&p_year=$p_year&p_month=$p_month&p_yearmonth=$p_yearmonth'>$title_report_0402</a></option>");
				}
			...
			if($mode) {
				...
				$main_module = "div_report_0401.inc";
			}
