...
include "config/user_functions_{$lang}.inc";
    ...
    $query = "SELECT uid,org_pcode,org_barcode,pname,price_sale,dc_rate FROM shop_product_list WHERE $find ORDER BY org_pcode ASC";
    $fetch = mysql_query($query);
    while ($row = mysql_fetch_array($fetch)) {
        $data[] = array( 
         'label' => $row['org_pcode'].' - '.$row['org_barcode']
